...
"""Verify that starting xcelr with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start xcelr with -h for help text")
        ...
        self.log.info("Start xcelr with -version for version information")
